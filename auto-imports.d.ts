...
declare global {
  ...
  const httpProgress: typeof import('./src/api/request')['httpProgress']
  const lazy: typeof import('react')['lazy']
  const memo: typeof import('react')['memo']
  const progressData: typeof import('./src/api/request')['progressData']
  const request: typeof import('./src/api/request')['default']
  const startTransition: typeof import('react')['startTransition']
  const uploadEventGather: typeof import('./src/utils/uploadEventGather')['default']
